...
<?
ob_end_clean();
$title = 'Недвижимость.Должники';
$array = array("№ п/п", "ФИО", "Размер долга", "Адрес", " Доля размера долга от стоимости жилья");
$xls = new PHPExcel();
$xls->getProperties()->setTitle($title);
$xls->getProperties()->setSubject("lab5");
$xls->getProperties()->setCreator("Александра Ярулина");
$xls->getProperties()->setCompany("USATU");
$xls->getProperties()->setKeywords("Недвижимость");
...
header("Content-Disposition: attachment; filename=Недвижимость.Должники.xls");
